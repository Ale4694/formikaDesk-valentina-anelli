...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::prezzi_cliente::get_riepilogo_cliente,
            commands::prezzi_cliente::get_documenti_cliente,
            commands::prezzi_cliente::get_articoli_venduti_cliente,
            commands::prezzi_cliente::get_movimenti_cliente,
            commands::prezzi_cliente::get_movimenti_articolo_cliente,
            commands::prezzi_cliente::get_ultimo_documento_vendita_cliente,
            commands::prezzi_cliente::get_clienti_per_articolo,
            commands::prezzi_cliente::get_prezzo_suggerito,
            commands::prezzi_cliente::list_prezzi_cliente,
            commands::prezzi_cliente::upsert_prezzo_cliente,
            commands::prezzi_cliente::delete_prezzo_cliente,
            commands::dashboard::get_dashboard_stats,
            commands::dashboard::get_clienti_piu_attivi,
            commands::dashboard::get_clienti_top_documenti,
            ...
            commands::report::get_report_giornaliero,
            commands::report::get_report_annuale,
            commands::report::get_report_personalizzato,
