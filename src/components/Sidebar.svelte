<script lang="ts">
  import { currentView, ricambiSottoScorta, searchOpen, setError, setSuccess } from '../lib/stores'
  ...
  const navItems: { id: View; label: string; icon: string }[] = [
    ...
    { id: 'magazzino',       label: 'Magazzino',        icon: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4' },
    { id: 'clienti',         label: 'Clienti',          icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z' },
    { id: 'veicoli',         label: 'Veicoli',          icon: 'M9 17H7m10 0h-2M3 10l2-5h14l2 5M3 10h18v6a1 1 0 01-1 1H4a1 1 0 01-1-1v-6z' },
    { id: 'fornitori',       label: 'Fornitori',        icon: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4' },
    { id: 'ordini-fornitore',label: 'Ordini Forn.',     icon: 'M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z' },
    ...
    { id: 'nuova-fattura',   label: 'Nuova Fattura',    icon: 'M12 4v16m8-8H4' },
    { id: 'scadenzario',     label: 'Scadenzario',      icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
    { id: 'cassa',           label: 'Cassa',            icon: 'M9 7H6a2 2 0 00-2 2v9a2 2 0 002 2h12a2 2 0 002-2V9a2 2 0 00-2-2h-3m-1 4l-3 3m0 0l-3-3m3 3V4' },
    { id: 'storico-cassa',   label: 'Storico Cassa',    icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01' },
    { id: 'impostazioni',    label: 'Impostazioni',     icon: 'M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z M15 12a3 3 0 11-6 0 3 3 0 016 0z' },
  ]
...
<aside class="bg-gray-900 border-r border-gray-800 flex flex-col shrink-0 transition-all duration-200 {collapsed ? 'w-14' : 'w-60'}">
  ...
  <div class="p-3 border-b border-gray-800 flex items-center {collapsed ? 'justify-center' : 'gap-3 px-5'}">
    ...
    {#if !collapsed}
      <div>
        <p class="text-sm font-semibold text-white">AutoParts</p>
        <p class="text-xs text-gray-500">Gestionale</p>
      </div>
    {/if}
  </div>
