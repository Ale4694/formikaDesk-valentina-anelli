...
<machine_hash> è l'ID dispositivo mostrato nell'app (SHA256 già calcolato).

Uso:
  python3 genera_chiave.py <machine_hash> demo <YYYY-MM-DD>
  python3 genera_chiave.py <machine_hash> perm <YYYY-MM-DD>

Esempi:
  python3 genera_chiave.py c8f317c7abcdef12... demo 2026-06-23
  python3 genera_chiave.py c8f317c7abcdef12... perm 2027-06-08
"""
